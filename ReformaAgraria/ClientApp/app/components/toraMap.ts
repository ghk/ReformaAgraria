    ...
    setupControlBar() {
        ...
        let button = L.Control.extend({
            ...
            onAdd: (map: L.Map) => {
                ...
                div.innerHTML = '<button type="button" class="btn btn-outline-secondary btn-sm" style="width:44px; height:44px; padding-top: 0.5rem"><strong><i class="material-icons"></i></strong></button>';
                div.onclick = (e) => { 
                    this.clearModal();
