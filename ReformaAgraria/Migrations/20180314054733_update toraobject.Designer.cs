...
namespace ReformaAgraria.Migrations
{
    ...
    [Migration("20180314054733_update toraobject")]
    partial class updatetoraobject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReformaAgraria.Models.Persil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ReformaAgraria.Models.ToraObject", b =>
                {
                    ...
                    b.HasIndex("FkSchemeId")
                        .HasName("ix_tora_object_fk_scheme_id");
            ...
            modelBuilder.Entity("ReformaAgraria.Models.ToraSubject", b =>
                {
                    ...
                    b.Property<int?>("FkPersilId")
                        .HasColumnName("fk_persil_id");
                    ...
                    b.HasIndex("FkPersilId")
                        .HasName("ix_tora_subject_fk_persil_id");
            ...
            modelBuilder.Entity("ReformaAgraria.Models.ToraObject", b =>
                {
                    ...
                    b.HasOne("ReformaAgraria.Models.Scheme", "Scheme")
                        .WithMany()
                        .HasForeignKey("FkSchemeId")
                        .HasConstraintName("fk_tora_object_scheme_fk_scheme_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("ReformaAgraria.Models.ToraSubject", b =>
                {
                    b.HasOne("ReformaAgraria.Models.Persil", "Persil")
                        .WithMany()
                        .HasForeignKey("FkPersilId")
                        .HasConstraintName("fk_tora_subject_persil_fk_persil_id");
