...
namespace ReformaAgraria.Migrations
{
    ...
    [Migration("20171212024859_Change_BaseLayers_to_BaseLayer")]
    partial class Change_BaseLayers_to_BaseLayer
    {
            ...
            modelBuilder.Entity("ReformaAgraria.Models.VillageMapAttribute", b =>
                {
                    ...
                    b.Property<int>("BorderSettingProcessStage")
                        .HasColumnName("border_setting_process_stage");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_village_map_attribute");

                    b.HasIndex("FkCoordinateId")
                        .HasName("ix_village_map_attribute_fk_coordinate_id");

                    b.HasIndex("FkRegionId")
                        .HasName("ix_village_map_attribute_fk_region_id");

                    b.ToTable("village_map_attribute");
                });
            ...
            modelBuilder.Entity("ReformaAgraria.Models.VillageMapAttribute", b =>
                {
                    b.HasOne("ReformaAgraria.Models.Coordinate", "Coordinate")
                        .WithMany()
                        .HasForeignKey("FkCoordinateId")
                        .HasConstraintName("fk_village_map_attribute_coordinate_fk_coordinate_id");

                    b.HasOne("ReformaAgraria.Models.Region", "Region")
                        .WithMany()
                        .HasForeignKey("FkRegionId")
                        .HasConstraintName("fk_village_map_attribute_region_fk_region_id");
                });
